...
/*   Updated: 2017/12/13 11:38:20 by ncella           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_info(t_mlx *smlx)
{
	...
	mlx_string_put(smlx->mlx, smlx->win, 10, 70, 0x00FFFFFF, "zoom  +    : d");
	mlx_string_put(smlx->mlx, smlx->win, 10, 90, 0x00FFFFFF, "zoom  -    : c");
	...
	mlx_string_put(smlx->mlx, smlx->win, 10, 230, 0x00FFFFFF,
		"retry      : i");
	mlx_string_put(smlx->mlx, smlx->win, 10, 250, 0x00FFFFFF,
		"exit       : esc");
}
